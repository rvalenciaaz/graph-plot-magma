...
do
    ...
    input_matrix_file="order_8_matrix_$i.txt"
    output_matrix_file="order_8_matrix_${i}_transformed.txt"
    ...
    python every_operation_fdiff.py "$input_matrix_file" "$output_matrix_file" -o 1 -y
done
